...
// if you want yav to highligh fields with errors inputhighlight: true,
...
errorsdiv: 'errorsDiv',
// if you want yav to alert you for javascript errors (only for developers) debugmode: false,
...
alnumhyphen_regex : "^[A-Za-z0-9\--]+$",
alnumhyphenat_regex : "^[A-Za-z0-9\-_@]*$",
alphaspace_regex: "A[A-Za-z0-9\-_ \n\r\t]*$",
email_regex :
...
ALNUMHYPHEN_MSG: '{1} is not valid. Characters allowed: A-Za-z0-9\- ',
ALNUMHYPHENAT_MSG: '{1} is not valid. Characters allowed: A-Za-z0-9\--@',
ALPHASPACE_MSG : '{1} is not valid. Characters allowed: A-Za-z0-9\--space',
